...
public class Tekstgrensesnitt {
	...
	public static Medlem lesMedlem() {
		...
		System.out.println("Hobbyer (Skriv zz for � stoppe): ");
	...
	public static void skrivParListe (Datakontakt arkiv) {
		...
		for (int i = 0; i < arkiv.getAntall() ; i++) {
			if (medlemmer[i].getStatusIndeks() != -1) {
				System.out.print(medlemmer[i].getNavn() + " og " + medlemmer[medlemmer[i].getStatusIndeks()].getNavn());
				System.out.println("\t  " + medlemmer[i].getHobby());
				antallPar++;	
			}
		}
		System.out.println("----------------");
		System.out.print("Antall par funnet: " + antallPar);
	}
}
